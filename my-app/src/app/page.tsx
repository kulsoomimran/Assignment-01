...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center">
      <h1 className="text-4xl font-bold mb-6 drop-shadow-lg border-transparent bg-violet-300">
        Welcome to The CHARMLY
      </h1>
      <h2 className="text-2xl font-semibold bg-slate-500 text-white">
        where elegance meets craftsmanship
      </h2>
      <div className="text-xl p-3 m-3">
        <p>
